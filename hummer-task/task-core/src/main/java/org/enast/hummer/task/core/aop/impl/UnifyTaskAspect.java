package org.enast.hummer.task.core.aop.impl;

import org.enast.hummer.task.core.aop.UnifyTask;
import org.enast.hummer.task.core.common.ServerUtils;
import org.enast.hummer.task.core.remotecall.service.ClientUnifyTaskService;
import org.enast.hummer.task.core.vo.TaskAjaxResult;
import org.enast.hummer.task.core.vo.UnifyTaskStatus;
...
public class UnifyTaskAspect {
    ...
    @Pointcut("@annotation(org.enast.hummer.task.core.aop.UnifyTask)")
